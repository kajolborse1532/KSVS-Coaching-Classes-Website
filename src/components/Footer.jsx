        ...
        <footer className="footer">
            <div className="footer-content">
                <div className="about">
                    ...
                    <p><span color='pink'>At KSVS Coaching Centre, we are dedicated to helping students achieve their goals through comprehensive suggestions and expert guidance.</span></p>
                </div>
                ...
                <div className="get-in-touch">
                    ...
                    <p>Email: ksvscoaching@gmail.com</p>
                </div>
            </div>
